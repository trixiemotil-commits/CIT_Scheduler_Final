...
const { register, login, verifyLoginOtp, selectRole, logoutSession, me, updateMe, requestPasswordOtp, changePassword, requestPasswordReset, verifyPasswordOtp, resetPassword } = require("../controllers/authController");
