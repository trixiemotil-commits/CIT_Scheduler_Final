  ...
  <div class="layout">
    <aside class="sidebar admin-sidebar">
      ...
      <nav class="sidebar-nav">
        <RouterLink v-for="item in navItems" :key="item.to" :to="item.to" class="nav-item" :class="{ active: route.path === item.to, 'unified-academic-link': item.to === '/admin/academic-terms' }">
...
const navItems = [
  ...
  { name: 'Academic Terms', to: '/admin/academic-terms', icon: icon('<path d="M4 4h16v16H4z"/><path d="M8 8h8M8 12h8M8 16h5"/>') },
